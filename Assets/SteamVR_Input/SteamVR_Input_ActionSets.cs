...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_Transforms p_Transforms;
        ...
        public static SteamVR_Input_ActionSet_Transforms Transforms
        {
            get
            {
                return SteamVR_Actions.p_Transforms.GetCopy<SteamVR_Input_ActionSet_Transforms>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_Transforms = ((SteamVR_Input_ActionSet_Transforms)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_Transforms>("/actions/Transforms")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.Transforms};
        }
    }
}
